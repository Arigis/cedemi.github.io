...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-7672075.707114, -2153411.276275, -6937477.313865, -1743965.996864], maxZoom: 28, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-7672075.707114, -2153411.276275, -6937477.313865, -1743965.996864], map.getSize());
...
//move controls inside containers, in order
    ...
    coordinateFormat: ol.coordinate.createStringXY(4), // 4 decimales
    projection: 'EPSG:4326', // Muestra Lat/Lon (WGS84)
    className: 'custom-mouse-position',
    target: document.getElementById('mouse-position'), // Div donde se mostrará
    undefinedHTML: '&nbsp;'
    });
