...
var lyr_RecurrenciainundacionesNeventos_2 = new ol.layer.Image({
        opacity: 0.6,
        
    title: 'Recurrencia inundaciones (N° eventos)<br />Periodo 2012-2024<br />\
    <img src="styles/legend/RecurrenciainundacionesNeventos_2_0.png" /> 1: Muy baja (1 evento)<br />\
    <img src="styles/legend/RecurrenciainundacionesNeventos_2_1.png" /> 2: Baja (1 a 5)<br />\
    <img src="styles/legend/RecurrenciainundacionesNeventos_2_2.png" /> 3: Moderada (5 a 10)<br />\
    <img src="styles/legend/RecurrenciainundacionesNeventos_2_3.png" /> 4: Alta (10 a 20)<br />\
    <img src="styles/legend/RecurrenciainundacionesNeventos_2_4.png" /> 5: Muy alta (> 20)<br />' ,
        
        
        source: new ol.source.ImageStatic({
            url: "./layers/RecurrenciainundacionesNeventos_2.png",
            attributions: ' ',
            projection: 'EPSG:3857',
            alwaysInRange: true,
            imageExtent: [-7447715.038512, -2108002.990627, -7146101.659920, -1791940.937494]
        })
    });
...
lyr_ESRIImagenSatelite_0.setVisible(false);lyr_OSMStandard_1.setVisible(true);lyr_RecurrenciainundacionesNeventos_2.setVisible(true);lyr_RegionesCochabamba_3.setVisible(true);lyr_Municipios_4.setVisible(false);
var layersList = [lyr_ESRIImagenSatelite_0,lyr_OSMStandard_1,lyr_RecurrenciainundacionesNeventos_2,lyr_RegionesCochabamba_3,lyr_Municipios_4];
