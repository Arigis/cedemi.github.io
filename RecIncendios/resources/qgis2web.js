...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-7709342.669843, -2159549.424212, -6906632.395385, -1732797.613000], maxZoom: 28, minZoom: 1
    })
});

//visualiza coordenadas del mouse
var mousePositionControl = new ol.control.MousePosition({
    coordinateFormat: ol.coordinate.createStringXY(5), // 5 decimales
    projection: 'EPSG:4326', // Coordenadas geográficas (WGS84)
    className: 'custom-mouse-position',
    target: document.getElementById('mouse-position'), // Contenedor HTML
    undefinedHTML: '&nbsp;'
});
map.addControl(mousePositionControl);

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-7709342.669843, -2159549.424212, -6906632.395385, -1732797.613000], map.getSize());
...
attributionList.innerHTML = `
	<a href="https://gobernaciondecochabamba.bo/web/inicio">GADC</a> &middot;
    <a href="https://sites.google.com/view/cedemi/">CEDEMI</a> &middot;
...
// FULL EXTENT
// 1. Definir el botón de Full Extent
var fullExtentControl = new ol.control.ZoomToExtent({
    // Si quieres una extensión específica, pon las coordenadas aquí [minX, minY, maxX, maxY]
    // Si lo dejas vacío, usará la extensión inicial de las capas
    extent: [-7609342.669843, -2159549.424212, -7006632.395385, -1732797.613000], maxZoom: 28, minZoom: 1, 
    label: '⌂', // Icono de casita o el texto que prefieras
    tipLabel: 'Extensión total'
});

// 2. Añadirlo al mapa
map.addControl(fullExtentControl);
