...
var lyr_RecurrenciaheladasNeventos_2 = new ol.layer.Image({
        opacity: 0.6,
        
    title: 'Recurrencia heladas (N° eventos)<br />Periodo 2012-2024<br />\
    <img src="styles/legend/RecurrenciaheladasNeventos_2_0.png" /> 1: Muy baja (1)<br />\
    <img src="styles/legend/RecurrenciaheladasNeventos_2_1.png" /> 2: Baja (1 a  5)<br />\
    <img src="styles/legend/RecurrenciaheladasNeventos_2_2.png" /> 3: Moderada (5 a 8)<br />\
    <img src="styles/legend/RecurrenciaheladasNeventos_2_3.png" /> 4: Alta (8 a 10)<br />\
    <img src="styles/legend/RecurrenciaheladasNeventos_2_4.png" /> 5 Muy Alta (>10)<br />' ,
        
        
        source: new ol.source.ImageStatic({
            url: "./layers/RecurrenciaheladasNeventos_2.png",
            attributions: ' ',
            projection: 'EPSG:3857',
            alwaysInRange: true,
            imageExtent: [-7457757.353894, -2112689.939514, -7151758.617140, -1889375.450817]
        })
    });
...
lyr_ESRIImagenSatelite_0.setVisible(false);lyr_OSMStandard_1.setVisible(true);lyr_RecurrenciaheladasNeventos_2.setVisible(true);lyr_RegionesCochabamba_3.setVisible(true);lyr_Municipios_4.setVisible(false);
var layersList = [lyr_ESRIImagenSatelite_0,lyr_OSMStandard_1,lyr_RecurrenciaheladasNeventos_2,lyr_RegionesCochabamba_3,lyr_Municipios_4];
