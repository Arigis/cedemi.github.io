...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-7685310.156558, -2172896.875642, -6919037.746927, -1715697.774747], maxZoom: 28, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-7685310.156558, -2172896.875642, -6919037.746927, -1715697.774747], map.getSize());
...
attributionList.innerHTML = `
	<a href="https://osc.org.bo/index.php/es/">OSC</a> &middot;
    <a href="https://ds.iris.edu/ieb/index.html">IEB</a> &middot;
