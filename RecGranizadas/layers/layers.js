...
var lyr_RecurrenciaGranizadasNeventos_2 = new ol.layer.Image({
        opacity: 0.6,
        
    title: 'Recurrencia Granizadas (N° eventos)<br />Periodo 2012-2024<br />\
    <img src="styles/legend/RecurrenciaGranizadasNeventos_2_0.png" /> 1: Muy baja (< 2)<br />\
    <img src="styles/legend/RecurrenciaGranizadasNeventos_2_1.png" /> 2: Baja (2 a 5)<br />\
    <img src="styles/legend/RecurrenciaGranizadasNeventos_2_2.png" /> 3: Moderada (5 a 10)<br />\
    <img src="styles/legend/RecurrenciaGranizadasNeventos_2_3.png" /> 4: Alta (10 a 15)<br />\
    <img src="styles/legend/RecurrenciaGranizadasNeventos_2_4.png" /> 5: Muy alta (>15)<br />' ,
        
        
        source: new ol.source.ImageStatic({
            url: "./layers/RecurrenciaGranizadasNeventos_2.png",
            attributions: ' ',
            projection: 'EPSG:3857',
            alwaysInRange: true,
            imageExtent: [-7454425.184449, -2107936.356200, -7151862.071169, -1886768.308844]
        })
    });
...
lyr_ESRIImagenSatelite_0.setVisible(false);lyr_OSMStandard_1.setVisible(true);lyr_RecurrenciaGranizadasNeventos_2.setVisible(true);lyr_RegionesCochabamba_3.setVisible(true);lyr_Municipios_4.setVisible(false);
var layersList = [lyr_ESRIImagenSatelite_0,lyr_OSMStandard_1,lyr_RecurrenciaGranizadasNeventos_2,lyr_RegionesCochabamba_3,lyr_Municipios_4];
